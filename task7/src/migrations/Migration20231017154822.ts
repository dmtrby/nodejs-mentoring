...
export class Migration20231017154822 extends Migration {
  ...
  async up(): Promise<void> {
    ...
    this.addSql('create table "order" ("id" varchar(255) not null, "user_id" varchar(255) not null, "cart_id" varchar(255) not null, "payment_id" varchar(255) not null, "delivery_id" varchar(255) not null, "comments" varchar(255) not null, "status" varchar(255) not null default \'created\', "total" int not null, constraint "order_pkey" primary key ("id"));');
    ...
    this.addSql('create table "order_item" ("product_id" varchar(255) not null, "order_id" varchar(255) not null, "count" int not null, "offered_price" int not null, constraint "order_item_pkey" primary key ("product_id", "order_id"));');

    this.addSql('create table "cart_item" ("product_id" varchar(255) not null, "cart_id" varchar(255) not null, "count" int not null, constraint "cart_item_pkey" primary key ("product_id", "cart_id"));');
